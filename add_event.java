...
public class add_event extends AppCompatActivity  implements View.OnClickListener{
    ...
    private EditText Ngo_name,Number,Address,Desc,Event_name;
    ...
    private String UPLOAD_URL = "http://patelnishtha009.000webhostapp.com/FCNC/add_event.php";
    ...
    private void uploadImage() {
        ...
        final String event_name = Event_name.getText().toString().trim();
        ...
        if (ngo_name.length() == 0) {
            Toast.makeText(add_event.this, "Please Enter Ngo name", Toast.LENGTH_LONG).show();
        } else {
            if (!isValidNumber(number)) {
                Toast.makeText(add_event.this, "Please Enter lastname", Toast.LENGTH_LONG).show();
                ...
                if (!isValidNumber(number)) {
                    ...
                    if (address.length() == 0) {
                        Toast.makeText(add_event.this, "Please Enter Assress", Toast.LENGTH_LONG).show();
                    } else {

                        if (description.length() == 0) {
                            Toast.makeText(add_event.this, "Please Enter description", Toast.LENGTH_LONG).show();
                        } else {

                            registerUser(image, email,ngo_name,event_name, number, address, description);
    ...
    public void registerUser(final String image,final String email, final String ngo_name, final String event_name,
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, UPLOAD_URL,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            Intent ver = new Intent(add_event.this, NgoProfile.class);
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        Toast.makeText(add_event.this, error.toString(), Toast.LENGTH_LONG).show();
                    }
            ...
            protected Map<String, String> getParams() {
                ...
                params.put(KEY_EVENT,event_name);
