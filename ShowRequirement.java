...
public class ShowRequirement extends TabActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Intent intent = new Intent(this, ViewMoney.class);
        ...
        Intent intent1 = new Intent(this, ViewMaterial.class);
